...
chcp 65001 >nul
REM =====================================================================
REM  UPDATE 1.50.71 - ONE CLICK - آمن على قاعدة البيانات والإعدادات
REM
REM  ماذا يفعل:
...
REM
REM  الاستخدام:  شغّل هذا الملف (من داخل الحزمة التي تحتوي publish_1.50.71\)
REM =====================================================================
...
if not exist "%NEW%\MfgSystem.exe" (
  ...
  echo          فك الحزمة كاملة أو شغّل BUILD-PUBLISH-1.50.71-WINDOWS.bat أولاً.
  exit /b 1
)
