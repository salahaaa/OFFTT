...
chcp 65001 >nul
REM =====================================================================
REM  BUILD + PUBLISH 1.50.73 (ONE CLICK) - Windows
REM  يبني الحلين (DateERP.sln بما فيه audit/ + DatesErp.sln) ثم ينشر
REM  MfgSystem.exe حقيقي self-contained win-x64 في publish_1.50.73\
...
set "PKG=UPDATE_1.50.73_PACKAGE"
...
echo ============================================================
echo   [1/5] فحص سلامة المصدر (VERIFY-SOURCE-1.50.73.bat)
echo ============================================================
if not exist "VERIFY-SOURCE-1.50.73.bat" (
  echo [FAILED] VERIFY-SOURCE-1.50.73.bat غير موجود — فك حزمة UPDATE_1.50.73_FIXED2 كاملة.
  exit /b 1
)
...
copy /Y "UPDATE_1.50.73_ONECLICK\UPDATE-1.50.73-ONECLICK.bat" "%PKG%\" >nul
copy /Y "UPDATE_1.50.73_ONECLICK\README_AR.txt" "%PKG%\" >nul

echo.
echo ============================================================
echo   [OK] اكتمل البناء والنشر بنجاح:
echo   - البرنامج المنشور:  %OUT%\MfgSystem.exe
echo   - حزمة التحديث:      %PKG%\  (انسخها للهدف وشغّل UPDATE-1.50.73-ONECLICK.bat)
